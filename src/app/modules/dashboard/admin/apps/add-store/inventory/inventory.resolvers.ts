...
export class InventoryCoordinatesResolver implements Resolve<any>
{
    /**
     * Constructor
     */
     ...
     * @param state
     */
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<InventoryCoordinates[]>
    {
...
export class InventoryGovernorateResolver implements Resolve<any>
{
    /**
     * Constructor
     */
     ...
     * @param state
     */
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<InventoryGovernorate[]>
    {
