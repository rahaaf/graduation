...
import { InventoryCoordinatesResolver, InventoryGovernorateResolver, InventoryProductsResolver } from 'app/modules/dashboard/admin/apps/add-store/inventory/inventory.resolvers';
