...
import { CanDeactivateContactsDetails } from 'app/modules/dashboard/admin/apps/contacts/contacts.guards';
import { ContactsContactResolver, ContactsCountriesResolver, ContactsResolver, ContactsTagsResolver } from 'app/modules/dashboard/admin/apps/contacts/contacts.resolvers';
